#+TITLE: Executable Manuscripts: A Survey from Knuth to Agentic Science
...
artifact of science is not a paper /about/ computation but the
computation /itself/ — has a clear lineage.

** Knuth's Literate Programming (1984)

Donald Knuth's WEB system (1984) is the origin. The core insight:
programs should be written for /human readers/, with code extracted by
...
Knuth's vision was more radical than what followed. WEB had a /macro
system/ that allowed the author to present code in any order convenient
...
/exploratory/ tool, not a /publication/ medium.
...
the most polished /authoring/ tool for computational manuscripts.
...
*Assessment*: Org-babel remains the most /technically capable/ literate
...
[[https://curvenote.com/][Curvenote]] launched its Scientific Content Management System (SCMS) in
...
Curvenote represents the VC-funded bet that /scientific publishing
infrastructure/ is a viable business. Their SCMS concept — treating
...
[[https://elifesciences.org/labs/dc5acbde/welcome-to-a-new-era-of-reproducible-publishing][eLife's Executable Research Articles (ERA)]], built with Stencila
(open-source), represent the most ambitious /journal-led/ attempt at
...
[[https://codeocean.com/][Code Ocean]] takes a different approach: containerised "compute capsules"
...
institutional adoption. Weakness: the capsule is /adjacent/ to the
paper, not /the paper itself/. You still read a PDF and separately
click into a capsule. The narrative and computation are decoupled.

** Nextjournal

[[https://nextjournal.com/][Nextjournal]] offers polyglot notebooks (Python, R, Julia, Clojure) with
...
[[https://idl.uw.edu/living-papers-paper/living-papers/][Living Papers]] from the UW Interactive Data Lab is the most ambitious
/academic/ project in this space:
...
This is the most /practical/ option for a working scientist today who
...
[[https://sakana.ai/ai-scientist-first-publication/][The AI Scientist v2]] is an end-to-end agentic system that:
...
reported a /negative result/ in regularization methods.

This is not an executable manuscript — it's an /automated manuscript
generator/. The distinction matters. AI Scientist v2 produces
...
current generation of AI-powered literature tools. These are /reading/
tools, not /writing/ or /executing/ tools. They help find and
...
1. *Authoring tools* (Org-babel, Quarto, MyST): help you /write/
   executable documents. Reader experience is passive — you can read
   the output, maybe re-run it, but you can't /interrogate/ it.

2. *Execution platforms* (Code Ocean, Binder, Nextjournal): let you
   /run/ someone else's code. But the code is decoupled from the
   narrative. You click a "launch Binder" button and leave the paper.

3. *AI agents* (AI Scientist, Agent Laboratory): can /produce/
...
*What's missing*: a system where the manuscript /is/ the executable
environment, and AI agents are /native participants/ — not just
producers or consumers of the document, but entities that can be
invoked /within/ it to explain, extend, challenge, or replicate the
claims.
...
- A peer review protocol where the reviewer is an agent that clones
  ...
  Scientist's self-review) but as a /standard publication workflow/
...
2. *Portal for distribution* — MayaPortal can render the /output/ of
   ...
   but as a /reading and interrogation/ environment.
...
** Foundational
- [[https://www-cs-faculty.stanford.edu/~knuth/lp.html][Knuth: Literate Programming]] (1984)
- [[https://orgmode.org/worg/org-contrib/babel/intro.html][Org-babel: Introducing Babel]]
- [[https://en.wikipedia.org/wiki/Literate_programming][Wikipedia: Literate Programming]]

** Executable Manuscript Platforms
- [[https://elifesciences.org/labs/dc5acbde/welcome-to-a-new-era-of-reproducible-publishing][eLife ERA: Welcome to a new ERA of reproducible publishing]]
- [[https://curvenote.com/][Curvenote: Web-first Scientific Publishing]]
- [[https://curvenote.com/news/curvenote-seed-round][Curvenote raises $1.4M seed round]] (2025)
- [[https://www.nature.com/articles/d41586-024-02577-1][Nature: A publishing platform that places code front and centre]] (2024)
- [[https://codeocean.com/product/compute-capsules][Code Ocean: Compute Capsules]]
- [[https://nextjournal.com/][Nextjournal: Reproducible Notebooks]]
- [[https://idl.uw.edu/living-papers-paper/living-papers/][Living Papers: Augmented Scholarly Communication]] (UIST 2023)
- [[https://quarto.org/][Quarto: Open-source scientific publishing]]
- [[https://mystmd.org/guide][MyST Markdown Tools]]
- [[https://2i2c.org/blog/fosdem-jupyter-book-2/][Jupyter Book 2 at FOSDEM 2026]]
- [[https://proceedings.scipy.org/articles/hwcj9957][Jupyter Book 2 and the MyST Document Stack — SciPy 2025]]

** AI-Native Science
- [[https://sakana.ai/ai-scientist-first-publication/][Sakana: AI Scientist Generates First Peer-Reviewed Publication]] (2025)
- [[https://arxiv.org/abs/2504.08066][AI Scientist v2: Workshop-Level Automated Discovery]] (2025)
- [[https://arxiv.org/html/2503.08979v1][Agentic AI for Scientific Discovery (ICLR 2025 survey)]]
- [[https://arxiv.org/html/2508.14111v1][From AI for Science to Agentic Science (survey)]]
- [[https://www.frontiersin.org/journals/artificial-intelligence/articles/10.3389/frai.2025.1649155/full][AI, agentic models and lab automation: the beginning of scAInce]]
- [[https://www.arxiv.org/pdf/2601.04226][Automated Reproducibility Has a Problem Statement]] (2026)

** Reproducibility Infrastructure
- [[https://www.frontiersin.org/journals/computer-science/articles/10.3389/fcomp.2024.1491823/full][Reproducible research policies survey]] (Frontiers, 2024)
- [[https://apertureneuro.org/article/143700][Neurodesk: Reproducible research artefacts]] (Aperture Neuro)
- [[https://portal.bluebrain.epfl.ch/][Blue Brain Project Portal]]
- [[https://www.frontiersin.org/journals/physics/articles/10.3389/fphy.2025.1711356/full][Scientific software development in the AI era]] (Frontiers, 2025)
